...
"""
Configuration loader for Reflow.
...
from app.constants.path import REFLOW_SETTINGS
from app.core.shared import ConfigurationError

logger = logging.getLogger("reflow.config")


class ConfigLoader:
    """
    Load and access Reflow configuration.
    ...
    def _load(self) -> dict[str, Any]:
        ...
        try:
            ...
            return raw.get("tool", {}).get("reflow", {})
    ...
    def resolve(
        ...
        *,
        ...
        """
        Resolve a value using Reflow's configuration priority.
