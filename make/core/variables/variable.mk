# Central variables for Reflow Make workflows.
...
# Shared Reflow CLI arguments. Runtime-specific variables inherit these values
# and can still be overridden independently from the make command line.
REFLOW_GLOBAL_ARGS ?=
REFLOW_EXTRA_ARGS ?=
REFLOW_INIT_ARGS ?=
...
LOCAL_REFLOW_GLOBAL_ARGS ?= $(REFLOW_GLOBAL_ARGS)
LOCAL_REFLOW_EXTRA_ARGS ?= $(REFLOW_EXTRA_ARGS)
LOCAL_REFLOW_INIT_ARGS ?= $(REFLOW_INIT_ARGS)
LOCAL_REFLOW_RELEASES_RECOVER_ARGS ?= $(REFLOW_RELEASES_RECOVER_ARGS)
LOCAL_REFLOW_TAGS_CONVERT_ARGS ?= $(REFLOW_TAGS_CONVERT_ARGS)
LOCAL_REFLOW_DOCKERIZE_ARGS ?= $(REFLOW_DOCKERIZE_ARGS)

# Docker image and runtime configuration.
DOCKER ?= docker
DOCKER_COMPOSE ?= $(DOCKER) compose
DOCKER_TAG ?= latest
DOCKER_REPOSITORY ?= reflow
...
DOCKER_REFLOW_GLOBAL_ARGS ?= $(REFLOW_GLOBAL_ARGS)
DOCKER_REFLOW_EXTRA_ARGS ?= $(REFLOW_EXTRA_ARGS)
DOCKER_REFLOW_INIT_ARGS ?= $(REFLOW_INIT_ARGS)
DOCKER_REFLOW_RELEASES_RECOVER_ARGS ?= $(REFLOW_RELEASES_RECOVER_ARGS)
DOCKER_REFLOW_TAGS_CONVERT_ARGS ?= $(REFLOW_TAGS_CONVERT_ARGS)
DOCKER_REFLOW_DOCKERIZE_ARGS ?= $(REFLOW_DOCKERIZE_ARGS)
...
COMPOSE_REFLOW_GLOBAL_ARGS ?= $(REFLOW_GLOBAL_ARGS)
COMPOSE_REFLOW_EXTRA_ARGS ?= $(REFLOW_EXTRA_ARGS)
COMPOSE_REFLOW_INIT_ARGS ?= $(REFLOW_INIT_ARGS)
COMPOSE_REFLOW_RELEASES_RECOVER_ARGS ?= $(REFLOW_RELEASES_RECOVER_ARGS)
COMPOSE_REFLOW_TAGS_CONVERT_ARGS ?= $(REFLOW_TAGS_CONVERT_ARGS)
COMPOSE_REFLOW_DOCKERIZE_ARGS ?= $(REFLOW_DOCKERIZE_ARGS)
...
REMOTE_REFLOW_GLOBAL_ARGS ?= $(REFLOW_GLOBAL_ARGS)
REMOTE_REFLOW_EXTRA_ARGS ?= $(REFLOW_EXTRA_ARGS)
REMOTE_REFLOW_INIT_ARGS ?= $(REFLOW_INIT_ARGS)
REMOTE_REFLOW_RELEASES_RECOVER_ARGS ?= $(REFLOW_RELEASES_RECOVER_ARGS)
REMOTE_REFLOW_TAGS_CONVERT_ARGS ?= $(REFLOW_TAGS_CONVERT_ARGS)
REMOTE_REFLOW_DOCKERIZE_ARGS ?= $(REFLOW_DOCKERIZE_ARGS)
