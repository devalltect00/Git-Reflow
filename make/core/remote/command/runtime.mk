...
REMOTE_REFLOW_RUNTIME_COMMANDS_LIST := \
	...
	r-reflow-tags-convert-local r-reflow-tags-convert-local-dryrun \
	r-reflow-tags-convert-remote r-reflow-tags-convert-remote-dryrun \
...
.PHONY: r-reflow-tags-convert-local
r-reflow-tags-convert-local:
	$(call REQUIRE_REMOTE)
	$(call ENSURE_REMOTE_IMAGE,REMOTE_IMAGE_REFLOW)
	$(call REMOTE_RUN,REMOTE_IMAGE_REFLOW) \
		$(REMOTE_REFLOW_GLOBAL_ARGS) \
...
.PHONY: r-reflow-tags-convert-local-dryrun
r-reflow-tags-convert-local-dryrun: override REMOTE_REFLOW_GLOBAL_ARGS += --dry-run
r-reflow-tags-convert-local-dryrun: r-reflow-tags-convert-local

.PHONY: r-reflow-tags-convert-remote
r-reflow-tags-convert-remote:
	$(call REQUIRE_REMOTE)
	$(call ENSURE_REMOTE_IMAGE,REMOTE_IMAGE_REFLOW)
	$(call REMOTE_RUN,REMOTE_IMAGE_REFLOW) \
		$(REMOTE_REFLOW_GLOBAL_ARGS) \
...
.PHONY: r-reflow-tags-convert-remote-dryrun
r-reflow-tags-convert-remote-dryrun: override REMOTE_REFLOW_GLOBAL_ARGS += --dry-run
r-reflow-tags-convert-remote-dryrun: r-reflow-tags-convert-remote

.PHONY: r-reflow-tags-convert r-reflow-tags-convert-dryrun
r-reflow-tags-convert: r-reflow-tags-convert-local
r-reflow-tags-convert-dryrun: r-reflow-tags-convert-local-dryrun
