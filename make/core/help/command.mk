# Aggregated help commands and module-loading order for help fragments.
...
define HELP_CONTENT_LOCAL
	...
	@$(MAKE) --no-print-directory help-local-reflow
...
define HELP_CONTENT_DOCKER
	...
	@$(MAKE) --no-print-directory help-docker-reflow
...
define HELP_CONTENT_COMPOSE
	...
	@$(MAKE) --no-print-directory help-compose-reflow
